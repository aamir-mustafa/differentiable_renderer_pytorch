...
folder_name= 'Sphere_Transformations_17'
...
for _, mesh in mesh_list:
    mesh.normals = pyredner.compute_vertex_normal(mesh.vertices/15, mesh.indices)
    print (_) # None
...
shape_sphere = pyredner.Shape(vertices = mesh.vertices/15,
...
img = render(0, *scene_args)  # renders an exr image
...
target= to_tensor(im)   # This is a png image
